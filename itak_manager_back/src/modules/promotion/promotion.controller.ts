...
export class PromotionController {
  ...
  @ApiOperation({ summary: 'Obtenir la classe supérieure pour une classe donnée' })
  ...
  @ApiOperation({ summary: 'Promouvoir un étudiant vers une classe supérieure' })
  ...
  @Post('bulk-promote')
  @ApiOperation({ summary: 'Promouvoir tous les étudiants d\'une classe vers une classe supérieure' })
  ...
  @ApiOperation({ summary: 'Obtenir l\'historique des promotions d\'un étudiant' })
  ...
  @ApiOperation({ summary: 'Obtenir les classes d\'une catégorie triées par niveau hiérarchique' })
