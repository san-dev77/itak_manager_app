...
import { AssessmentSubject, FileType } from '../../entities/assessment-subject.entity';
...
export class AssessmentSubjectService {
  ...
  async update(
    ...
    if (file) {
      ...
      subject.fileType = updateDto.fileType || this.fileUploadService.getFileTypeFromMimeType(file.mimetype) as FileType;
