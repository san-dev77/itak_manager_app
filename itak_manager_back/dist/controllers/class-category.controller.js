...
const class_category_service_1 = require("../services/class-category.service");
...
let ClassCategoryController = class ClassCategoryController {
    ...
    async updateClassCategory(id, updateClassCategoryDto) {
        return this.classCategoryService.updateClassCategory(parseInt(id, 10), updateClassCategoryDto);
    }
