...
exports.Timetable = exports.DayOfWeek = void 0;
...
__decorate([
    ...
    (0, typeorm_1.Index)(),
    __metadata("design:type", String)
], Timetable.prototype, "teachingAssignmentId", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'uuid', nullable: false }),
    (0, typeorm_1.Index)(),
    __metadata("design:type", String)
], Timetable.prototype, "academicYearId", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: DayOfWeek,
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => teaching_assignment_entity_1.TeachingAssignment, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'teaching_assignment_id' }),
    __metadata("design:type", teaching_assignment_entity_1.TeachingAssignment)
], Timetable.prototype, "teachingAssignment", void 0);
__decorate([
...
], Timetable.prototype, "academicYear", void 0);
exports.Timetable = Timetable = __decorate([
    (0, typeorm_1.Entity)('timetables'),
    (0, typeorm_1.Index)(['teachingAssignmentId', 'academicYearId', 'dayOfWeek', 'startTime']),
    (0, typeorm_1.Index)(['academicYearId', 'dayOfWeek', 'startTime'])
], Timetable);
